...
tic;
maxx=floor(size(theta_dot,2)/3);
for i_theta=1:maxx
    
%     if i_theta > maxx
%         i_theta = i_theta - maxx;
%     end
...
this_frame_self2=this_frame_self.';
sychronize=[sychronize; [current_9xyz this_frame_self2(2:end-1)];];
...
sychronize;
% save('tableback5_20211215_zengcheng.mat','sychronize');