close all;clear;clc;
right= load ('right.mat').sychronize;
left= load ('left.mat').sychronize;
down= load ('down.mat').sychronize;
up2= load ('up2.mat').sychronize;
forward= load ('for.mat').sychronize;
up1= load ('up1.mat').sychronize;
back= load ('back.mat').sychronize;
