...
%         hold on;
% end
list_seperate_rate=2:1:2; list_rate_add=0:2;
...
%     plot(new_which_want,want,'o','MarkerSize',10)
    ...
    for each_slop = 1:length(new_which_want)
        ...
        if this_slope > 0
            this_round_train_X=[this_round_train_X; [new_this_round(each_slope,7:9) label1];];
        else
            this_round_train_X=[this_round_train_X; [new_this_round(each_slope,7:9) label2];];
        end
        ...
        this_round_train_Y=[this_round_train_Y; new_this_round(each_slope+1,7:9);];
...
% % seeee~
% % figure(37)
% % plot(train_X_xyz5(:,3)); hold on; plot(train_Y_xyz5(:,3))
% close all;
% each_test=1;
...
% % figure(37)
% % plot(each_test_file(30:end,xyz)); 
%  
% xyz=1; start=40
% 
% 
...
for rate_add = list_rate_add
    ...
    for each_test = num_all_intent
        ...
        if each_intent == 1 
              new_gprMdl_1 = gprMdl_x1;
              new_gprMdl_2 = gprMdl_y1;
              new_gprMdl_3 = gprMdl_z1;
        elseif each_intent == 2
              new_gprMdl_1 = gprMdl_x2;
              new_gprMdl_2 = gprMdl_y2;
              new_gprMdl_3 = gprMdl_z2;
        elseif each_intent == 3
              new_gprMdl_1 = gprMdl_x3;
              new_gprMdl_2 = gprMdl_y3;
              new_gprMdl_3 = gprMdl_z3;              
        elseif each_intent == 4
              new_gprMdl_1 = gprMdl_x4;
              new_gprMdl_2 = gprMdl_y4;
              new_gprMdl_3 = gprMdl_z4;      
        elseif each_intent == 5
              new_gprMdl_1 = gprMdl_x5;
              new_gprMdl_2 = gprMdl_y5;
              new_gprMdl_3 = gprMdl_z5;
        elseif each_intent == 6
              new_gprMdl_1 = gprMdl_x6;
              new_gprMdl_2 = gprMdl_y6;
              new_gprMdl_3 = gprMdl_z6;              
        end
