...
%         end
        ...
        result = myGRP_beta(each_test_file_left(:,1:end-1), each_intent, new_gprMdl_1,new_gprMdl_2,new_gprMdl_3,new_gprMdl_4,new_gprMdl_5,new_gprMdl_6,new_gprMdl_7,new_gprMdl_8);
