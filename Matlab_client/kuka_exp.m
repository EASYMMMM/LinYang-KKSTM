%% Create by Lin YANG this file is used to sychronize ZED from the other computer, 
%kinect from this computer in C++, and EMG signal from another MATLAB 
...
all_target_end_effector_p_next=[];all_feedback_joint_velocity_after=[];
 ...
 %%  TC/PIP from the other computer 
