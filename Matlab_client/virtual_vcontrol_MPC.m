...
init_pos=[-0.463647609000806,0.820126730911849,0,-1.17997019621945,0,1.14149572645849,0].';
count_loop=0;
rate_xdetjia=[];rate_target=[];
target_joint_position_next=[-0.463647609000806,0.820126730911849,0,-1.17997019621945,0,1.14149572645849,0];
