...
for FLAG = 1:3
    ...
    elseif FLAG == 1  % x
        wrist_direction=7; lower_bound=10; upper_bound=1100; label1=1; label2=2; howmany = 800;
    end
...
gprMdl_x1 = fitrgp(train_X_xyz1(:,[1 4]),train_Y_xyz1(:,1),'KernelFunction','squaredexponential','ComputationMethod','v','ActiveSetMethod','likelihood','OptimizeHyperparameters','auto','HyperparameterOptimizationOptions',struct('AcquisitionFunctionName','expected-improvement-plus'));
gprMdl_y1 = fitrgp(train_X_xyz1(:,[2 4]),train_Y_xyz1(:,2),'KernelFunction','squaredexponential','ComputationMethod','v','ActiveSetMethod','likelihood','OptimizeHyperparameters','auto','HyperparameterOptimizationOptions',struct('AcquisitionFunctionName','expected-improvement-plus'));
gprMdl_z1 = fitrgp(train_X_xyz1(:,[3 4]),train_Y_xyz1(:,3),'KernelFunction','squaredexponential','ComputationMethod','v','ActiveSetMethod','likelihood','OptimizeHyperparameters','auto','HyperparameterOptimizationOptions',struct('AcquisitionFunctionName','expected-improvement-plus'));

gprMdl_x2 = fitrgp(train_X_xyz2(:,[1 4]),train_Y_xyz2(:,1),'KernelFunction','squaredexponential','ComputationMethod','v','ActiveSetMethod','likelihood','OptimizeHyperparameters','auto','HyperparameterOptimizationOptions',struct('AcquisitionFunctionName','expected-improvement-plus'));
gprMdl_y2 = fitrgp(train_X_xyz2(:,[2 4]),train_Y_xyz2(:,2),'KernelFunction','squaredexponential','ComputationMethod','v','ActiveSetMethod','likelihood','OptimizeHyperparameters','auto','HyperparameterOptimizationOptions',struct('AcquisitionFunctionName','expected-improvement-plus'));
gprMdl_z2 = fitrgp(train_X_xyz2(:,[3 4]),train_Y_xyz2(:,3),'KernelFunction','squaredexponential','ComputationMethod','v','ActiveSetMethod','likelihood','OptimizeHyperparameters','auto','HyperparameterOptimizationOptions',struct('AcquisitionFunctionName','expected-improvement-plus'));

gprMdl_x3 = fitrgp(train_X_xyz3(:,[1 4]),train_Y_xyz3(:,1),'KernelFunction','squaredexponential','ComputationMethod','v','ActiveSetMethod','likelihood','OptimizeHyperparameters','auto','HyperparameterOptimizationOptions',struct('AcquisitionFunctionName','expected-improvement-plus'));
gprMdl_y3 = fitrgp(train_X_xyz3(:,[2 4]),train_Y_xyz3(:,2),'KernelFunction','squaredexponential','ComputationMethod','v','ActiveSetMethod','likelihood','OptimizeHyperparameters','auto','HyperparameterOptimizationOptions',struct('AcquisitionFunctionName','expected-improvement-plus'));
gprMdl_z3 = fitrgp(train_X_xyz3(:,[3 4]),train_Y_xyz3(:,3),'KernelFunction','squaredexponential','ComputationMethod','v','ActiveSetMethod','likelihood','OptimizeHyperparameters','auto','HyperparameterOptimizationOptions',struct('AcquisitionFunctionName','expected-improvement-plus'));

gprMdl_x4 = fitrgp(train_X_xyz4(:,[1 4]),train_Y_xyz4(:,1),'KernelFunction','squaredexponential','ComputationMethod','v','ActiveSetMethod','likelihood','OptimizeHyperparameters','auto','HyperparameterOptimizationOptions',struct('AcquisitionFunctionName','expected-improvement-plus'));
gprMdl_y4 = fitrgp(train_X_xyz4(:,[2 4]),train_Y_xyz4(:,2),'KernelFunction','squaredexponential','ComputationMethod','v','ActiveSetMethod','likelihood','OptimizeHyperparameters','auto','HyperparameterOptimizationOptions',struct('AcquisitionFunctionName','expected-improvement-plus'));
gprMdl_z4 = fitrgp(train_X_xyz4(:,[3 4]),train_Y_xyz4(:,3),'KernelFunction','squaredexponential','ComputationMethod','v','ActiveSetMethod','likelihood','OptimizeHyperparameters','auto','HyperparameterOptimizationOptions',struct('AcquisitionFunctionName','expected-improvement-plus'));

gprMdl_x5 = fitrgp(train_X_xyz5(:,[1 4]),train_Y_xyz5(:,1),'KernelFunction','squaredexponential','ComputationMethod','v','ActiveSetMethod','likelihood','OptimizeHyperparameters','auto','HyperparameterOptimizationOptions',struct('AcquisitionFunctionName','expected-improvement-plus'));
gprMdl_y5 = fitrgp(train_X_xyz5(:,[2 4]),train_Y_xyz5(:,2),'KernelFunction','squaredexponential','ComputationMethod','v','ActiveSetMethod','likelihood','OptimizeHyperparameters','auto','HyperparameterOptimizationOptions',struct('AcquisitionFunctionName','expected-improvement-plus'));
gprMdl_z5 = fitrgp(train_X_xyz5(:,[3 4]),train_Y_xyz5(:,3),'KernelFunction','squaredexponential','ComputationMethod','v','ActiveSetMethod','likelihood','OptimizeHyperparameters','auto','HyperparameterOptimizationOptions',struct('AcquisitionFunctionName','expected-improvement-plus'));

gprMdl_x6 = fitrgp(train_X_xyz6(:,[1 4]),train_Y_xyz6(:,1),'KernelFunction','squaredexponential','ComputationMethod','v','ActiveSetMethod','likelihood','OptimizeHyperparameters','auto','HyperparameterOptimizationOptions',struct('AcquisitionFunctionName','expected-improvement-plus'));
gprMdl_y6 = fitrgp(train_X_xyz6(:,[2 4]),train_Y_xyz6(:,2),'KernelFunction','squaredexponential','ComputationMethod','v','ActiveSetMethod','likelihood','OptimizeHyperparameters','auto','HyperparameterOptimizationOptions',struct('AcquisitionFunctionName','expected-improvement-plus'));
gprMdl_z6 = fitrgp(train_X_xyz6(:,[3 4]),train_Y_xyz6(:,3),'KernelFunction','squaredexponential','ComputationMethod','v','ActiveSetMethod','likelihood','OptimizeHyperparameters','auto','HyperparameterOptimizationOptions',struct('AcquisitionFunctionName','expected-improvement-plus'));
...
%     each_test_file_Y_left=[each_test_file_Y_left - each_test_file_Y_left(1,:)];    
        ...
        if each_intent == 1 
            temp_combine_X=[each_test_file_add; train_X_xyz1;];
             ...
             temp_combine_Y_draw=temp_combine_Y(:,1);
              ...
              new_gprMdl_1 = updateGPRMdl(gprMdl_x1, temp_combine_X(:,[1 4]),  temp_combine_Y(:,1));
              new_gprMdl_2 = updateGPRMdl(gprMdl_y1, temp_combine_X(:,[2 4]),  temp_combine_Y(:,2));
              new_gprMdl_3 = updateGPRMdl(gprMdl_z1, temp_combine_X(:,[3 4]),  temp_combine_Y(:,3));
        elseif each_intent == 2
              temp_combine_X=[each_test_file_add; train_X_xyz2;];
             temp_combine_Y=[each_test_file_Y_add; train_Y_xyz2;];          
              temp_combine_X_draw=temp_combine_X(:,1);
             temp_combine_Y_draw=temp_combine_Y(:,1);           
              new_gprMdl_1 = updateGPRMdl(gprMdl_x2, temp_combine_X(:,[1 4]),  temp_combine_Y(:,1));
              new_gprMdl_2 = updateGPRMdl(gprMdl_y2, temp_combine_X(:,[1 4]),  temp_combine_Y(:,2));
              new_gprMdl_3 = updateGPRMdl(gprMdl_z2, temp_combine_X(:,[1 4]),  temp_combine_Y(:,3));
        elseif each_intent == 3
             ...
             temp_combine_Y_draw=temp_combine_Y(:,2);             
              new_gprMdl_1 = updateGPRMdl(gprMdl_x3, temp_combine_X(:,[1 4]),  temp_combine_Y(:,1));
              new_gprMdl_2 = updateGPRMdl(gprMdl_y3, temp_combine_X(:,[2 4]),  temp_combine_Y(:,2));
              new_gprMdl_3 = updateGPRMdl(gprMdl_z3, temp_combine_X(:,[3 4]),  temp_combine_Y(:,3));
        ...
        elseif each_intent == 4
             ...
             temp_combine_X_draw=temp_combine_X(:,2);
             temp_combine_Y_draw=temp_combine_Y(:,2);             
              new_gprMdl_1 = updateGPRMdl(gprMdl_x4, temp_combine_X(:,[1 4]),  temp_combine_Y(:,1));
              new_gprMdl_2 = updateGPRMdl(gprMdl_y4, temp_combine_X(:,[2 4]),  temp_combine_Y(:,2));
              new_gprMdl_3 = updateGPRMdl(gprMdl_z4, temp_combine_X(:,[3 4]),  temp_combine_Y(:,3));
        elseif each_intent == 5
             ...
             temp_combine_Y_draw=temp_combine_Y(:,3);             
              new_gprMdl_1 = updateGPRMdl(gprMdl_x5, temp_combine_X(:,[1 4]),  temp_combine_Y(:,1));
              new_gprMdl_2 = updateGPRMdl(gprMdl_y5, temp_combine_X(:,[2 4]),  temp_combine_Y(:,2));
              new_gprMdl_3 = updateGPRMdl(gprMdl_z5, temp_combine_X(:,[3 4]),  temp_combine_Y(:,3));
        elseif each_intent == 6
             temp_combine_X=[each_test_file_add; train_X_xyz6;];
             temp_combine_Y=[each_test_file_Y_add; train_Y_xyz6;];         
             temp_combine_X_draw=temp_combine_X(:,3);
             temp_combine_Y_draw=temp_combine_Y(:,3);
              new_gprMdl_1 = updateGPRMdl(gprMdl_x6, temp_combine_X(:,[1 4]),  temp_combine_Y(:,1));
              new_gprMdl_2 = updateGPRMdl(gprMdl_y6, temp_combine_X(:,[2 4]),  temp_combine_Y(:,2));
              new_gprMdl_3 = updateGPRMdl(gprMdl_z6, temp_combine_X(:,[3 4]),  temp_combine_Y(:,3));
        end
