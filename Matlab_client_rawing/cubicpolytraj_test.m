function [ q, qd, qdd, pp, velBC] = cubicpolytraj_test(wayPoints, timePoints, t, varargin)
...
%     velBC(:,1) = input_vinit;
    ...
    for i = 1:p-1
        ...
        for j = 1:n
            coeffMat(j,:) = generateCubicCoeffs_test(wayPoints(j,i:i+1), velBC(j, i:i+1), finalTime);
...
function coeffVec = generateCubicCoeffs_test(posPts, velPts, finalTime)
