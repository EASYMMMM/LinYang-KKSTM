...
gprMdl_x1=load('gprMdl.mat').gprMdl_x1;
gprMdl_x2=load('gprMdl.mat').gprMdl_x2;
gprMdl_y1=load('gprMdl.mat').gprMdl_y1;
gprMdl_y2=load('gprMdl.mat').gprMdl_y2;
gprMdl_z1=load('gprMdl.mat').gprMdl_z1;
gprMdl_z2=load('gprMdl.mat').gprMdl_z2;
...
%         train_Xo=[train_Xo  [fea1(:,intent_o); fea2(:,intent_o); fea3(:,intent_o); fea4(:,intent_o);] ];
        ...
        test_Xo=[test_Xo  map_EMG(sele_st:sele_end,intent_o)];
