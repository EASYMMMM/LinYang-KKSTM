...
Quaternion = robot.Quaternion_of_table()';
...
%             [dists,grads] = distancesAndGrads_tableU(q, this_obs, delta, 0, myspace,0);
    ...
    F=J*q0_dot;
    all_F=[all_F F];
    target_v3=points_dot3(:,i);
    
    
% [dists,grads] = distancesAndGrads_tableU(q, 115, delta, 0, myspace,0)
% find_distance([0.0601; -0.5186; 0.4673;], 79, myspace, 0)
