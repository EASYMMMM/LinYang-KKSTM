...
target_joint_velocity_next=[0 0 0 0 0 0 0].';all_this_point=[];last_p=target_joint_position_next;all_xetjia=[];v_filt=[0 0 0].';
 ...
 accu_point=1;diminish=0;delete_point=1;
  thre=2;div=1;all_this_point_after=[];all_real_point=[];MDZZ=[];
 tic
...
[y,iy]=min(abs(refer_pos(1,:)-init_direction(1)));
