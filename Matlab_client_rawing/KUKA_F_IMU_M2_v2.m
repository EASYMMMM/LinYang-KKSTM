...
theta_points=[0,41.0257993937885,0,-78.6675247753817,0,54.8066758308298,0]*pi/180;
...
elseif BOTTOM == 1 && FUCKact(end) == 3
    if HELP == 1
        contact_force_after(3)=-EMG7/8;
    else
        contact_force_after(3)=-EMG7/4;
    end
elseif BOTTOM == 1 && FUCKact(end) == -3
    if HELP == 1
        contact_force_after(3)=-EMG5/8;
    else
